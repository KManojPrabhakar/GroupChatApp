                ...
                UserModel.findOne({ email: req.body.email.toLowerCase()}, (err, userDetails) => {
                    ...
                    if (err) {
                        ...
                        /* prepare the message and the api response here */
                         mailMessages = {
                            email:req.body.email.toLowerCase(),
                            text:'Hey, you successfully login from chat'
                        }
    ...
    let validatePassword = (retrievedUserDetails) => {
        ...
        return new Promise((resolve, reject) => {
            passwordLib.comparePassword(req.body.password, retrievedUserDetails.password, (err, isMatch) => {
                ...
                mailMessages.subject=(retrievedUserDetails.firstName)+', welcome  to your chat'; //for sending  subject in mail 
                if (err) {
                    console.log(err)
...
let logout = (req, res) => {
    ...
    AuthModel.findOneAndRemove({userId: saveUserId}, (err, result) => {
    if (err) {
        console.log(err)
